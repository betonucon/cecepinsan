...
<div id="content" class="content">
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Daftar Pengumuman <small></small></h1>
    <!-- end page-header -->
    <!-- begin row -->
    <div class="row">
        <!-- begin col-6 -->
        <div class="col-xl-12" style="margin-bottom:1%">
            <a href="javascript:;" onclick="location.assign(`{{url('pengumuman/create')}}?id=0`)" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Tambah</a>
        </div>
        <div class="col-xl-12">
            <!-- begin panel -->
