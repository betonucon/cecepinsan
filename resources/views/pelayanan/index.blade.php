...
<div id="content" class="content">
    ...
    <ol class="breadcrumb float-xl-right">
        ...
        <li class="breadcrumb-item active">Pelayanan {{$data->pelayanan}}</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Daftar Pelayanan  {{$data->pelayanan}}<small></small></h1>
    <!-- end page-header -->
    <!-- begin row -->
    <div class="row">
        <!-- begin col-6 -->
                        ...
                        <table id="data-table-fixed-header" class="table table-striped table-bordered table-td-valign-middle   dt-responsive display nowrap" cellspacing="0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-nowrap" width="12%">NIK</th>
                                    <th class="text-nowrap" width="18%">Nama</th>
                                    <th class="text-nowrap">Pelayanan</th>
                                    <th class="text-nowrap" width="11%">Waktu Permintaan</th>
        ...
        var handleDataTableFixedHeader = function() {
            ...
            if ($('#data-table-fixed-header').length !== 0) {
                var table=$('#data-table-fixed-header').DataTable({
                    ...
                    responsive: true,
                    ajax:"{{ url('pelayanan/'.$tipe.'/get_data')}}",
					columns: [
