...
class PengumumanController extends Controller
{
    ...
    {
        $template='top';
        return view('pengumuman.index',compact('template'));
    }
    public function create(request $request)
    {
        ...
        return view('pengumuman.create',compact('template','data','disabled','id'));
    }
    ...
    public function get_data(request $request)
    {
        ...
        return Datatables::of($data)
            ...
            ->addColumn('action', function ($row) {
                $btn='
                    <div class="btn-group">
                        <span class="btn btn-primary btn-sm" onclick="location.assign(`'.url('pengumuman/create').'?id='.$row->id.'`)"><i class="fas fa-pencil-alt text-white"></i></span>
